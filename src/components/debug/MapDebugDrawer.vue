...
const { drawerOpen, layout, reset } = useMapDebug()
...
<template>
  <transition name="drawer">
    <aside v-if="drawerOpen" class="drawer">
      ...
      <div class="actions">
        <button class="btn" @click="copyCss">{{ copied ? '已复制 ✓' : '复制 CSS' }}</button>
...
.css-out {
  margin-top: auto; padding: 10px 12px; font-size: 12px; line-height: 1.6;
